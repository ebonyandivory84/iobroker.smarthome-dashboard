...
export function buildWidgetTemplate(
  ...
  if (type === "camera") {
    return {
      ...
      refreshMs: 2000,
      audioEnabled: false,
      showDetectionIcons: true,
      personDetectionIconType: "material",
      personDetectionMaterialIcon: "account",
      personDetectionIconImage: "person_icon_transparent.png",
      carDetectionIconType: "material",
      carDetectionMaterialIcon: "car",
      carDetectionIconImage: "car_icon_transparent.png",
      catDetectionIconType: "material",
      catDetectionMaterialIcon: "cat",
      catDetectionIconImage: "cat_icon_transparent.png",
      position: {
        ...basePosition,
  ...
  if (type === "wallbox" || type === "goe") {
    ...
    return {
      ...
      chargedEnergyDisplayMode: "session",
