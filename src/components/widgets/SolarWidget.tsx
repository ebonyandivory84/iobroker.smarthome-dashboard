...
function getDefaultNodeLayout(
  ...
  if (compactTablet) {
    return {
      ...
      battery: { x: 0.0, y: 0.48, w: 0.22, h: 0.18 },
      grid: { x: 0.78, y: 0.48, w: 0.22, h: 0.18 },
      car: { x: 0.35, y: 0.86, w: 0.3, h: 0.14 },
    };
  }

  return {
    pv: { x: 0.44, y: 0.02, w: 0.12, h: 0.18 },
    home: { x: 0.44, y: 0.47, w: 0.12, h: 0.18 },
    battery: { x: 0.14, y: 0.49, w: 0.1, h: 0.14 },
    grid: { x: 0.76, y: 0.49, w: 0.1, h: 0.14 },
    car: { x: 0.45, y: 0.89, w: 0.1, h: 0.14 },
  };
}
