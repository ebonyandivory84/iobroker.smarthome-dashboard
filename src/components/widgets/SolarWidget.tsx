...
function getDefaultNodeLayout(
  ...
  if (compactSingleColumn) {
    return {
      pv: { x: 0.385, y: 0.03, w: 0.23, h: 0.2 },
      home: { x: 0.38, y: 0.355, w: 0.24, h: 0.24 },
      battery: { x: 0.0, y: 0.385, w: 0.2, h: 0.18 },
      grid: { x: 0.8, y: 0.385, w: 0.2, h: 0.18 },
      car: { x: 0.35, y: 0.72, w: 0.3, h: 0.16 },
    };
  }

  if (compactTablet) {
    return {
      pv: { x: 0.38, y: 0.03, w: 0.24, h: 0.2 },
      home: { x: 0.39, y: 0.345, w: 0.22, h: 0.22 },
      battery: { x: 0.0, y: 0.365, w: 0.22, h: 0.18 },
      grid: { x: 0.78, y: 0.365, w: 0.22, h: 0.18 },
      car: { x: 0.35, y: 0.72, w: 0.3, h: 0.16 },
    };
  }
