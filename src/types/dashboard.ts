...
export type CameraWidgetConfig = WidgetBase & {
  ...
  tabletPreviewSourceMode?: "snapshot" | "mjpeg" | "flv" | "fmp4";
  tabletFullscreenSourceMode?: "snapshot" | "mjpeg" | "flv" | "fmp4";
  snapshotUrl?: string;
  fullscreenSnapshotUrl?: string;
  tabletSnapshotUrl?: string;
  tabletFullscreenSnapshotUrl?: string;
  mjpegUrl?: string;
  fullscreenMjpegUrl?: string;
  tabletMjpegUrl?: string;
  tabletFullscreenMjpegUrl?: string;
  flvUrl?: string;
  fullscreenFlvUrl?: string;
  tabletFlvUrl?: string;
  tabletFullscreenFlvUrl?: string;
  fmp4Url?: string;
  fullscreenFmp4Url?: string;
  tabletFmp4Url?: string;
  tabletFullscreenFmp4Url?: string;
  refreshMs?: number;
